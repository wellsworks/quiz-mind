...
export async function updateNote({ id, payload }: { id: string; payload: any; }): Promise<Note> {
...
export async function updateFlashcard({ id, payload }: { id: string; payload: any; }): Promise<Flashcard> {
